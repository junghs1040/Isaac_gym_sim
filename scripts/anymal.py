...
dof_handle1 = gym.find_actor_dof_handle(env0, cartpole0, 'LF_HAA')
dof_handle2 = gym.find_actor_dof_handle(env0, cartpole0, 'LF_HFE')
dof_handle3 = gym.find_actor_dof_handle(env0, cartpole0, 'LF_KFE')
dof_handle4 = gym.find_actor_dof_handle(env0, cartpole0, 'LH_KFE')
dof_handle5 = gym.find_actor_dof_handle(env0, cartpole0, 'LH_HFE')
dof_handle6 = gym.find_actor_dof_handle(env0, cartpole0, 'LH_KFE')
dof_handle7 = gym.find_actor_dof_handle(env0, cartpole0, 'RF_HAA')
dof_handle8 = gym.find_actor_dof_handle(env0, cartpole0, 'RF_HFE')
dof_handle9 = gym.find_actor_dof_handle(env0, cartpole0, 'RF_KFE')
dof_handle10 = gym.find_actor_dof_handle(env0, cartpole0, 'RH_HAA')
dof_handle11 = gym.find_actor_dof_handle(env0, cartpole0, 'RH_HFE')
dof_handle12 = gym.find_actor_dof_handle(env0, cartpole0, 'RH_KFE')
